...
class draw(Thread):
    def run(self):
        # Top Part
        piece1 = [
            [(-40, 120), (-70, 260), (-130, 230), (-170, 200), (-170, 100), (-160, 40), (-170, 10), (-150, -10),
             (-140, 10),
             (-40, -20), (0, -20)],
        ...
        # Middle Part
        piece2 = [
            [(-40, -30), (-50, -40), (-100, -46), (-130, -40), (-176, 0), (-186, -30), (-186, -40), (-120, -170),
             (-110, -210),
             (-80, -230), (-64, -210), (0, -210)],
...
class play(Thread):
    def run(self):
        playsound('file://C:/Users/ASUS/PycharmProjects/ironman2/cg.mp3')
